...
<div class="container">
    <div class="logo">
        {{-- SARAN: Ganti URL statis dengan helper asset() jika gambar ada di folder /public --}}
        {{-- <img src="{{ asset('images/logo_asrama.png') }}" alt="Logo Asrama" class="logo-img"> --}}
    ...
    <div class="cards-container">
        ...
        <a href="/asrama/mahasiswa/login" class="card">
        ...
        {{-- <a href="{{ route('informasi.asrama') }}" class="card"> --}}
        <a href="/asrama/mahasiswa/informasi" class="card">
