...
return [
    ...
    */
    ...
    'connections' => [
        ...
        'tertiary_sqlsrv' => [
            'driver' => 'sqlsrv',
            'url' => env('DB_TERTIARY_URL'),
            'host' => env('DB_TERTIARY_HOST', 'localhost'),
            'port' => env('DB_TERTIARY_PORT', '1433'),
            'database' => env('DB_TERTIARY_DATABASE', 'laravel'),
            'username' => env('DB_TERTIARY_USERNAME', 'root'),
            'password' => env('DB_TERTIARY_PASSWORD', ''),
            'charset' => env('DB_TERTIARY_CHARSET', 'utf8'),
            'prefix' => '',
            'prefix_indexes' => true,
            // 'encrypt' => env('DB_ENCRYPT', 'yes'),
            // 'trust_server_certificate' => env('DB_TRUST_SERVER_CERTIFICATE', 'false'),
        ...
        'quaternary_sqlsrv' => [
            'driver' => 'sqlsrv',
            'url' => env('DB_QUATERNARY_URL'),
            'host' => env('DB_QUATERNARY_HOST', 'localhost'),
            'port' => env('DB_QUATERNARY_PORT', '1433'),
            'database' => env('DB_QUATERNARY_DATABASE', 'laravel'),
            'username' => env('DB_QUATERNARY_USERNAME', 'root'),
            'password' => env('DB_QUATERNARY_PASSWORD', ''),
            'charset' => env('DB_QUATERNARY_CHARSET', 'utf8'),
            'prefix' => '',
            'prefix_indexes' => true,
            // 'encrypt' => env('DB_ENCRYPT', 'yes'),
            // 'trust_server_certificate' => env('DB_TRUST_SERVER_CERTIFICATE', 'false'),
        ...
        'quinary_sqlsrv' => [
            'driver' => 'sqlsrv',
            'url' => env('DB_QUINARY_URL'),
            'host' => env('DB_QUINARY_HOST', 'localhost'),
            'port' => env('DB_QUINARY_PORT', '1433'),
            'database' => env('DB_QUINARY_DATABASE', 'laravel'),
            'username' => env('DB_QUINARY_USERNAME', 'root'),
            'password' => env('DB_QUINARY_PASSWORD', ''),
            'charset' => env('DB_QUINARY_CHARSET', 'utf8'),
            'prefix' => '',
            'prefix_indexes' => true,
            // 'encrypt' => env('DB_ENCRYPT', 'yes'),
            // 'trust_server_certificate' => env('DB_TRUST_SERVER_CERTIFICATE', 'false'),
