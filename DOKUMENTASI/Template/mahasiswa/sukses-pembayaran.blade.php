...
<head>
    ...
    <title>Pembayaran Berhasil - Asrama Quality</title>
    ...
    <style>
        ...
        * {
        ...
        .success-icon i {
            transform: translateY(2px); /* Penyesuaian posisi ikon */
        }
        
        /* Teks instruksi/sapaan */
        .greeting-text {
            font-size: 1.2rem;
            font-family: 'Poppins', sans-serif;
            font-weight: 700;
...
<body>
    <div class="hero">
        ...
        <div class="container">
            ...
            <h2 class="page-title">Pembayaran Berhasil!</h2>
            <p class="subtitle">
                Terima kasih. Pendaftaran Anda telah kami konfirmasi.
            </p>
            ...
            <div class="success-card">
                ...
                <p class="instruction-text">
                    Pembayaran Anda telah kami terima dan verifikasi. Selamat datang di Asrama Quality!
                </p>
                ...
                <ul class="success-summary">
                    ...
                    <li>
                        ...
                        <span class="value">23 Oktober 2025, 09:30 WIB</span>
                    </li>
                </ul>
    ...
    <script>
        ...
        // ========================================
        // JAVASCRIPT TOMBOL SALIN DIHAPUS
        // (Karena sudah tidak ada tombol salin)
        // ========================================
